...
<html:form action="estadoCuentaCliente" styleId="formArea">
<tr>
...
<html:hidden property="iEstadoCuentaCliente" />
...
<html:hidden property="metodo" value="iduEstadoCuentaCliente" styleId="metodo" />
...
<script>
  ...
  function validarMonto(){
	   //  var x = $("#fMontoPago").val().split(",");
	    ...
	    // $(".mensaje.Validar").text("EL MONTO INGRESADO DEBE SER MENOR  \n   O IGUAL QUE EL MONTO DE VENTA= "+(montoTotal-pagoTotal));
