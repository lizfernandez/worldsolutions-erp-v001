...
<html:form action="perfil" styleId="formMantenimiento">
<tr class="trCodigo">
    <td align="right">C&oacute;digo:</td>
    <td><html:text property="cPerfilCodigo" styleId="cPerfilCodigo"  styleClass="text" onkeyup="return mayuscula('cPerfilCodigo')"  onkeypress="return LetrasNumeros(event)" maxlength="5" />
      <span id="m_cPerfilCodigo" class="importante">*</span>
    </td>
</tr>
<tr>
    <td align="right">Nombre:</td>
    <td>
       <html:text property="vPerfilDescripcion" styleId="vPerfilDescripcion" styleClass="text" onkeyup="return mayuscula('vPerfilDescripcion')"/>
        <span id="m_vPerfilDescripcion" class="importante">*</span>
   </td>
</tr>
<tr>
...
<html:hidden property="iPerfilId" />
...
<html:hidden property="metodo" value="iduPerfil" />
...
<script>
    ...
    if(mode=='I') {
        document.getElementById('cPerfilCodigo').focus();
