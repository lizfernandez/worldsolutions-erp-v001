...
<tr>
    ...
    <td> <html:select  property="iCategoriaId" styleId="iCategoriaId" styleClass="combo">       
...
<tr class="trCodigo">
    ...
    <td><html:text property="cSubCategoriaCodigo" styleId="cSubCategoriaCodigo" onkeyup="return mayuscula('cSubCategoriaCodigo')"  onkeypress="return LetrasNumeros(event)" maxlength="5" styleClass="text"/>
...
<html:hidden property="metodo" value="iduSubCategoria" styleId="metodo" />
