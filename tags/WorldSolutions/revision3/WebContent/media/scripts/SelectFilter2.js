...
var SelectFilter = {
    init: function(field_id, field_name, is_stacked, admin_media_prefix) {
        ...
        quickElement('img', filter_p, '', 'src', admin_media_prefix + 'images/admin/selector-search.gif');
        ...
        quickElement('img', selector_filter, '', 'src', admin_media_prefix + (is_stacked ? 'images/admin/selector_stacked-add.gif':'images/admin/selector-add.gif'), 'alt', 'Add');
        ...
        from_box.setAttribute('name', 'old_' + from_box.getAttribute('name'));
