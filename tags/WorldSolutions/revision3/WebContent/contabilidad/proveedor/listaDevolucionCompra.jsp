	    ...
	    <logic:iterate name="contabilidadForm" property="lista" id="x">	
			<tr>
				...
				<img title="Editar" src="${pageContext.request.contextPath}/media/imagenes/edit.png"
		                     onclick="popup('ingresoProducto.do?metodo=mantenimientoIngresoproductoDevolucion&mode=U&id=<bean:write name="x" property="iIngresoProductoDevolucionId" />',1320,620)" />
		        <% break;}}}%> 
		        </td>
