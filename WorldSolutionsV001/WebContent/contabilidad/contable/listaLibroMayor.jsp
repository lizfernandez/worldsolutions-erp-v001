...
<table class="tabla" border="0" width="100%" id="tabla">
    ...
    <thead>
    <tr><th colspan="4"><bean:write name="contabilidadForm" property="mes"/> </th></tr>
    <tr>
        
         
        <th align="left"  width="5%">C&oacute;digo</th>               
        <th align="left"  width="30%">Nombre de cuentas</th>        
        <th align="center"  width="9%">Monto Ingreso (D)</th> 
        <th align="center"  width="9%">Monto Egreso (H)</th>            
...
<logic:notEmpty name="contabilidadForm" property="lista">      
	...
	<tr>    
	    ...
	    <td><bean:write name="x" property="cuenta.vDescripcion" /></td>
		<td align="right"><bean:write name="x" property="fMontoDebe" format="#,##0.00" locale="Localidad"/></td>		
		<td align="right"><bean:write name="x" property="fMontoHaber" format="#,##0.00" locale="Localidad"/></td>			   
...
$("#mayor").css("background-image","linear-gradient(#21A8E7, #0D5DA2)");
$("#mayor").children('a').css("color","#D0D2D7");
