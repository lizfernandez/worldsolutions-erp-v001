...
<table border="0">
     <tr>
        <td><button  class="button" onclick="popup('productos.do?metodo=mantenimientoProducto&iclasificacionId=4&mode=I',450,520)">
        ...
        <td><button  class="button" onclick="popup('productos.do?metodo=mantenimientoProducto&mode=F&iclasificacionId=4',430,500)">
...
<logic:notEmpty name="contabilidadForm" property="lista"> 
	...
	<tr>
		...
		<td align="center"><img title="Editar" src="${pageContext.request.contextPath}/media/imagenes/edit.png"
		                     onclick="popup('productos.do?metodo=mantenimientoProducto&iclasificacionId=4&mode=U&id=<bean:write name="x" property="iProductoId" />',450,520)" /></td>
...
$("#embases").css("background-image","linear-gradient(#21A8E7, #0D5DA2)");
$("#embases").children('a').css("color","#D0D2D7");
