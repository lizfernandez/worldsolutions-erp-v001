	    ...
	    <logic:iterate name="ventaForm" property="lista" id="x">	
			<tr>
				...
				<img title="Editar" src="${pageContext.request.contextPath}/media/imagenes/edit.png"
		                     onclick="popup('venta.do?metodo=mantenimientoVenta&mode=U&id=<bean:write name="x" property="iVentaId" />&idTipoDocumento=<bean:write name="x" property="tipoDocumento.iTipoDocumentoGestionId" />&iclasificacionId=1',1500,800)" />
		        <% break;}}}%>      
		        </td>
