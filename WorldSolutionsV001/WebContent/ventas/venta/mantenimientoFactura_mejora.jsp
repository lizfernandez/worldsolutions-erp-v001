...
<table cellpadding="0" cellspacing="0"  style="width: 26%; float: left;">
   <tr>
      <td>
      <table border="1" cellpadding="0" cellspacing="0" class="tabla" id="tabla" style="float: right;">
...
<table class="tabla" border="0" width="100%" id="tabla">
    ...
    <tbody>
		 ...
		 <logic:iterate name="VentaForm" property="lista" id="x" indexId="i">	
...
<table cellpadding="0" cellspacing="0"  style="width: 61%; float: right;">
   <tr>
    <td>
...
<tr height="50px">   
   ...
   <tr>
      ...
      <td><table border="1" cellpadding="0" cellspacing="0" class="tabla" id="tabla" style="width: 54%; float: right;">
<tr style="height: 1px;"> 
    <td>
     <table width="100%" border="0" cellspacing="0" cellpadding="0">
            <tr> 
