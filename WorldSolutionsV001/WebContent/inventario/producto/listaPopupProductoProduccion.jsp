...
<html:form action="productos" styleId="formPersonal">
    <tr>
       <td> <html:select  property="iclasificacionId" styleId="iclasificacionId" styleClass="combo" style="width:150px " onchange="fn_recargar('produccion')">       
...
function fn_cargarProducto(iProductoId,vNombreProducto,iCantidadProducto,iUnidadMedidadId,iUMBase,iUMPedido,fProductoPrecioCompra,fProductoPrecioVenta,fGanancia){   
