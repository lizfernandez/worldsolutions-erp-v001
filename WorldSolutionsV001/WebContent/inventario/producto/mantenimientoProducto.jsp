...
<tr>
	 ...
	 <table class="tabla" id="tabla1">	  
		...
		<tr>
		    ...
		    <td><html:text property="vProductoCapacidad" styleId="vProductoCapacidad" maxlength="7"  styleClass="text"  tabindex="7"/> <!-- onkeyup="return mayuscula('vProductoDescripcion')" -->
		    </td>
		    <td>  
