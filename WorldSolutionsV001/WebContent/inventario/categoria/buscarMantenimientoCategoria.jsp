...
<tr>
    ...
    <td>
       <html:text property="vCategoriaDescripcion" styleId="vCategoriaDescripcion" onkeyup="return mayuscula('vCategoriaDescripcion')" styleClass="text" maxlength="45"/>
...
<html:hidden property="metodo" value="listaCategoria" styleId="metodo" />
