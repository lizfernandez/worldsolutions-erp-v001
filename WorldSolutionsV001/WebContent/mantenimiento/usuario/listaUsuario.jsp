...
<table border="0">
    <tr>
        <td><button  class="button" onclick="popup('usuario.do?metodo=mantenimientoUsuario&mode=I',350,250)">
        ...
        <td><button  class="button" onclick="popup('usuario.do?metodo=mantenimientoUsuario&mode=F',350,250)">
