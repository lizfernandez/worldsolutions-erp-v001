...
<table class="tabla" border="0" width="100%" id="tabla">
    <caption>Lista de clasificaci&oacute;n Clientes</caption>
        <!-- tr>
	    ...
	    <logic:notEmpty name="clienteForm" property="lista">
			...
			<tr>
				...
				<img title="Editar" src="${pageContext.request.contextPath}/media/imagenes/edit.png"
		                     onclick="popup('cliente.do?metodo=mantenimientoClasifCliente&mode=U&id=<bean:write name="x" property="iClasificacionClienteId" />',350,220)" />
		        <% break; }}}%>
		        </td>
		 	    <td align="center">
		 	    <%
		 	    ...
		 	    <img title="Eliminar" src="${pageContext.request.contextPath}/media/imagenes/delete.png"
		                     onclick="eliminar('tabla','<bean:write name="x" property="iClasificacionClienteId" />','cliente.do?metodo=iduClasifCliente&mode=D')" />
		        <% break; }}}%>
		         </td>	
