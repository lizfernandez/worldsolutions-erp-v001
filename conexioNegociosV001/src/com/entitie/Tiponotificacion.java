...
/**
 * The persistent class for the tiponotificacion database table.
 * 
 */
@Entity
public class Tiponotificacion implements Serializable {
	...
	private String iTipoNotificacionId;
	...
	public void setITipoNotificacionId(String iTipoNotificacionId) {
