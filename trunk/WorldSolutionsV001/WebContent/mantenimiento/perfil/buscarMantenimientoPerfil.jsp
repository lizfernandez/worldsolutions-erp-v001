...
<tr class="trCodigo">
    ...
    <td><html:text property="cPerfilCodigo" styleId="cPerfilCodigo" onkeyup="return mayuscula('cPerfilCodigo')"/>
    <span id="m_cPerfilCodigo" class="importante"></span></td>
</tr>
<tr>
    <td align="right">Nombre:</td>
    <td>
       <html:text property="vPerfilDescripcion" styleId="vPerfilDescripcion" onkeyup="return mayuscula('vPerfilDescripcion')"/>
...
<html:hidden property="metodo" value="listaPerfil" styleId="metodo" />
