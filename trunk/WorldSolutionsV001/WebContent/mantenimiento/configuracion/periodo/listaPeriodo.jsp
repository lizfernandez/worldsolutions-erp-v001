	    ...
	    <logic:notEmpty name="configuracionForm" property="lista">
			...
			<tr>
			   ...
			   if(per.equals("8522")){%>
				...
				<td><bean:write name="x" property="ejerciciofiscal.vNombreEjercicio" /></td>
...
$("#periodo").css("background-image","linear-gradient(#21A8E7, #0D5DA2)");
$("#periodo").children('a').css("color","#D0D2D7");
