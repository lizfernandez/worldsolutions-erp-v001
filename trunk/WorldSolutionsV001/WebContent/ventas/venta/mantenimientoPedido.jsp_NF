	      ...
	      <tr>
	        ...
	        <td width="50%" rowspan="2">
		        <table width="100%" border="1" cellspacing="0" cellpadding="0" id="numeroBoleta">
		          ...
		          <tr>
		            <td style="border-bottom:2px solid #666; border-top: 2px solid #666; background-color: #E6E6E6">NOTA DE PEDIDO</td>
		          </tr>
		          <tr>
    ...
    <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr style="height: 1px;">
            ...
            <tr>
                <td>FECHA:</td>
                <td>
                	<html:text property="dVentaFecha" styleId="dVentaFecha" styleClass="text" readonly="true" tabindex="1"/>
          ...
          <td>R.U.C :</td>
          <td colspan="3">
              <html:text property="nClienteNumeroDocumento" styleId="nClienteNumeroDocumento"  styleClass="text inputDisabled" readonly="true" /></td>
            <td>FORMA DE PAGO :</td>
            <td>
