...
<tr>
    ...
    <td> <html:select property="iSucursalId" styleId="iSucursalId" styleClass="combo" style="width:200px"> 
              <option value="0">::SELECCIONE::</option>       
              <html:options collection="listSucursal" property="iSucursalId" labelProperty="vSucursalNombre"/>
         </html:select>
     </td>
</tr>
<tr>
