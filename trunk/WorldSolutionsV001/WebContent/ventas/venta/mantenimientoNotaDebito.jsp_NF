     ...
     <tr style="height: 1px;">
      ...
      <tr>
        ...
        <table width="100%" border="1" cellspacing="0" cellpadding="0" id="numeroBoleta">
          ...
          <tr>
            <td style="border-bottom:2px solid #666; border-top: 2px solid #666; background-color: #E6E6E6">NOTA DE DEBITO</td>
          </tr>
          <tr>
  ...
  <tr style="height: 1px;">
    <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
        ...
        <td width="50%">
          ...
          <tr>
            <td>N° :</td>
            <td><html:text property="nVentaNumero"  styleId="nVentaNumero" maxlength="10" styleClass="text " /> </td>
             <td >FORMA DE PAGO :</td>
            <td  width="30%">
