...
<table border="0">
     <tr>
        <td><button  class="button" onclick="popup('productos.do?metodo=mantenimientoProducto&iclasificacionId=3&mode=I',430,500)">
        ...
        <td><button  class="button" onclick="popup('productos.do?metodo=mantenimientoProducto&mode=F&iclasificacionId=3',430,500)">
...
<logic:notEmpty name="contabilidadForm" property="lista"> 
	...
	<tr>
		...
		<td align="center"><img title="Editar" src="${pageContext.request.contextPath}/media/imagenes/edit.png"
		                     onclick="popup('productos.do?metodo=mantenimientoProducto&iclasificacionId=3&mode=U&id=<bean:write name="x" property="iProductoId" />',430,500)" /></td>
