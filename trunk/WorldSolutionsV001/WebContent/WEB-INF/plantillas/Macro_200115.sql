...
--
-- Servidor: localhost
-- Tiempo de generación: 20-01-2015 a las 23:40:11
...
(293, 6, '655', 'Otras Cargas Diversas de GestiÃ³n'),
...
CREATE TABLE IF NOT EXISTS `empresa` (
  ...
  `vEmpresaNombre` varchar(45) NOT NULL,
  `vEmpresaDireccion` varchar(45) NOT NULL,
  `vEmpresaTelefono` varchar(45) NOT NULL,
  `nEmpresaRUC` decimal(10,0) NOT NULL,
  `iUsuarioInsertaId` int(11) NOT NULL,
  `iUsuarioActualizaId` int(11) DEFAULT NULL,
  `dFechaInserta` date NOT NULL,
  `dFechaActualiza` date DEFAULT NULL,
...
INSERT INTO `empresa` (`iEmpresaId`, `vEmpresaNombre`, `vEmpresaDireccion`, `vEmpresaTelefono`, `nEmpresaRUC`, `iUsuarioInsertaId`, `iUsuarioActualizaId`, `dFechaInserta`, `dFechaActualiza`, `cEstadoCodigo`) VALUES
(2, 'Macroquimica del Peru', 'Av. pachacutec', '5485540', '989454545', 1, NULL, '2010-12-18', NULL, 'Ac');
...
(1, 1, 0, 57, '2013-02-22', '2013-02-22', 0, 'AC');
...
(1, 5.55, '2013-02-05', '2013-02-10', 1, 'AC', 2, 4, 'LIZ FERNNADEZ CEL: 949290057'),
(2, 800, '2015-01-15', '2015-01-15', 2, 'AC', 1, 6, NULL),
(3, 5.45, '2015-01-15', '2015-01-15', 2, 'AC', 1, 8, NULL),
(4, 500, '2015-01-15', '2015-01-15', 2, 'AC', 1, 12, NULL);
...
INSERT INTO `ingresoproducto` (`iIngresoProductoId`, `nIngresoProductoNumero`, `dIngresoProductoFecha`, `fIngresoProductoTotal`, `iUsuarioInsertaId`, `dFechaInserta`, `iUsuarioActualizaId`, `dFechaActualiza`, `cEstadoCodigo`, `iProveedorId`, `iTipoDocumentoId`, `iFormaPagoId`, `vPrincipal`, `fIngresoProductoSubTotal`, `fIngresoProductoIGV`, `vEstadoDocumento`, `vIngresoProductoPuntoLlegada`, `dFechaProximoPago`, `fDescuento`, `fIngresoProductoTotalReal`, `fMontoAdelantado`, `fPercepcion`, `iNumeroDias`, `iNumeroLetras`, `iPeriodoId`) VALUES
(1, '1', '2010-12-17', 485, 2, '2010-12-17', NULL, NULL, 'AC', 1, 4, 1, '0', NULL, NULL, 'DEUDA', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(5, '0001', '2015-01-01', 1090, 2, '2015-01-01', 0, NULL, 'AC', 1, 2, 1, '1', 923.73, 166.27, 'CANCELADO', 'AV CONQUISTADORES 304 ', '2015-01-01', 0, 1090, 0, 0, 0, 1, 6),
(6, '0002', '2015-01-15', 800, 2, '2015-01-15', 0, NULL, 'AC', 1, 2, 1, '1', 695.65, 104.35, 'CANCELADO', 'AV CONQUISTADORES 304 ', '2015-01-15', 0, 800, 0, 0, 0, 1, 7),
(7, '1561', '2015-01-15', 0, 2, '2015-01-15', 0, NULL, 'AC', 1, 1, 2, '1', 0, 0, 'DEUDA', 'AV CONQUISTADORES 304 ', '2015-01-30', 0, 0, 200, 0, 15, 1, 7),
(8, '12', '2015-01-15', 5.45, 2, '2015-01-15', 0, NULL, 'AC', 1, 2, 1, '1', 4.74, 0.71, 'CANCELADO', 'AV CONQUISTADORES 304 ', '2015-01-15', 0, 5.45, 0, 0, 0, 1, 7),
(9, '2121', '2015-01-15', 13, 2, '2015-01-15', 0, NULL, 'AC', 1, 3, 2, '1', 11.3, 1.7, 'DEUDA', 'AV CONQUISTADORES 304 ', '2015-01-30', 0, 13, 200, 0, 15, 1, 7),
(10, '545', '2015-01-15', 5.45, 2, '2015-01-15', 0, NULL, 'AC', 1, 2, 2, '1', 4.74, 0.71, 'DEUDA', 'AV CONQUISTADORES 304 ', '2015-01-30', 0, 5.45, 200, 0, 15, 1, 7),
(11, '241', '2015-01-15', 0, 2, '2015-01-15', 0, NULL, 'AC', 1, 2, 2, '1', 0, 0, 'DEUDA', 'AV CONQUISTADORES 304 ', '2015-01-30', 0, 0, 150, 0, 15, 1, 7),
(12, '656', '2015-01-15', 600, 2, '2015-01-15', 0, NULL, 'AC', 1, 2, 2, '1', 521.74, 78.26, 'DEUDA', 'AV CONQUISTADORES 304 ', '2015-01-30', 0, 600, 500, 0, 15, 1, 7),
(13, '656', '2015-01-15', 600, 2, '2015-01-15', 0, NULL, 'AC', 1, 2, 2, '1', 521.74, 78.26, 'DEUDA', 'AV CONQUISTADORES 304 ', '2015-01-30', 0, 600, 500, 0, 15, 1, 7),
(14, '1', '2015-01-15', 0, 2, '2015-01-15', 0, NULL, 'AC', 1, 2, 3, '1', 0, 0, 'DEUDA', 'AV CONQUISTADORES 304 ', '2015-03-02', 0, 0, 15, 0, 30, 1, 7),
(15, '156563', '2015-01-15', 60000, 2, '2015-01-15', 0, NULL, 'AC', 1, 1, 3, '1', 52173.9, 7826.09, 'DEUDA', 'AV CONQUISTADORES 304 ', '2015-03-02', 0, 60000, 51, 0, 30, 1, 7),
(16, '5454', '2015-01-15', 1300, 2, '2015-01-15', 0, NULL, 'AC', 1, 2, 5, '1', 1130.43, 169.57, 'DEUDA', 'AV CONQUISTADORES 304 ', '2015-01-30', 0, 1300, 0, 0, 15, 2, 7),
(17, '00001-0001', '2015-01-15', 8000, 2, '2015-01-15', 0, NULL, 'AC', 1, 2, 5, '1', 6956.52, 1043.48, 'DEUDA', 'AV CONQUISTADORES 304 ', '2015-01-30', 0, 8000, 0, 0, 15, 10, 7),
(18, '00001-0001', '2015-01-15', 8000, 2, '2015-01-15', 0, NULL, 'AC', 1, 1, 5, '1', 6956.52, 1043.48, 'DEUDA', 'AV CONQUISTADORES 304 ', '2015-01-30', 0, 8000, 0, 0, 15, 10, 7),
(19, '0002', '2015-01-15', 8000, 2, '2015-01-15', 0, NULL, 'AC', 1, 2, 5, '1', 6956.52, 1043.48, 'DEUDA', 'AV CONQUISTADORES 304 ', '2015-01-30', 0, 8000, 0, 0, 15, 10, 7),
(20, '00001-0001', '2015-01-15', 8000, 2, '2015-01-15', 0, NULL, 'AC', 1, 2, 5, '1', 6956.52, 1043.48, 'DEUDA', 'AV CONQUISTADORES 304 ', '2015-01-30', 0, 8000, 0, 0, 15, 10, 7),
(21, '00001-0001', '2015-01-15', 8000, 2, '2015-01-15', 0, NULL, 'AC', 1, 2, 1, '1', 6956.52, 1043.48, 'CANCELADO', 'AV CONQUISTADORES 304 ', '2015-02-02', 0, 8000, 0, 0, 15, 10, 7);
...
(1, 5, 50, 250, 1, '2010-12-17', 0, NULL, 'AC', 1, 2, NULL),
(5, 5.45, 200, 1090, 0, '2015-01-01', 0, NULL, 'AC', 5, 2, 0),
(6, 80, 10, 800, 0, '2015-01-15', 0, NULL, 'AC', 6, 8, 0),
(7, 5.45, 1, 5.45, 0, '2015-01-15', 0, NULL, 'AC', 8, 2, 0),
(8, 13, 1, 13, 0, '2015-01-15', 0, NULL, 'AC', 9, 7, 0),
(9, 5.45, 1, 5.45, 0, '2015-01-15', 0, NULL, 'AC', 10, 2, 0),
(10, 600, 1, 600, 0, '2015-01-15', 0, NULL, 'AC', 12, 9, 0),
(11, 600, 1, 600, 0, '2015-01-15', 0, NULL, 'AC', 13, 9, 0),
(12, 600, 100, 60000, 0, '2015-01-15', 0, NULL, 'AC', 15, 9, 0),
(13, 13, 100, 1300, 0, '2015-01-15', 0, NULL, 'AC', 16, 7, 0),
(14, 80, 100, 8000, 0, '2015-01-15', 0, NULL, 'AC', 17, 8, 0),
(15, 80, 100, 8000, 0, '2015-01-15', 0, NULL, 'AC', 18, 8, 0),
(16, 80, 100, 8000, 0, '2015-01-15', 0, NULL, 'AC', 19, 8, 0),
(17, 80, 100, 8000, 0, '2015-01-15', 0, NULL, 'AC', 20, 8, 0),
(18, 80, 100, 8000, 0, '2015-01-15', 0, '2015-01-18', 'AC', 21, 8, 0);
...
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COLLATE=utf8_spanish_ci AUTO_INCREMENT=206 ;
...
(174, 2, 5, NULL, '2015-01-01', 'COMPRA SEGÚN BOLETA N° 0001', 200, 5.45, 1090, 0, 0, 0, 200, 5.45, 1090, 2, '2015-01-01', 0, NULL, 'IN', 6, NULL),
(175, 2, NULL, 4, '2015-01-08', 'VENTA SEGÚN FACTURA N° 001-0011', 0, 0, 0, 1, 5.45, 5.45, 200, 5.45, 1090, 2, '2015-01-08', 0, NULL, 'IN', 7, NULL),
(176, 2, NULL, 4, '2015-01-08', 'XSaldo 0', 0, 0, 0, 0, 0, 0, 200, 5.45, 1090, 0, '2015-01-08', 0, NULL, 'IN', 7, NULL),
(177, 2, NULL, 4, '2015-01-08', 'VENTA SEGÚN FACTURA N° 001-0011', 0, 0, 0, 1, 5.45, 5.45, 0, 5.45, 0, 2, '2015-01-08', 0, NULL, 'IN', 7, NULL),
(178, 2, NULL, 4, '2015-01-08', 'VENTA SEGÚN FACTURA N° 001-0011', 0, 0, 0, 1, 5.45, 5.45, 0, 5.45, 0, 2, '2015-01-08', 0, NULL, 'IN', 7, NULL),
(179, 2, NULL, 5, '2015-01-10', 'VENTA SEGÚN NOTA N° 000N1-0001', 0, 0, 0, 1, 5.45, 5.45, 199, 5.45, 1084.55, 2, '2015-01-10', 0, NULL, 'IN', 7, NULL),
(180, 2, NULL, 5, '2015-01-10', 'VENTA SEGÚN NOTA N° 000N1-0001', 0, 0, 0, 0, 0, 0, 0, 5.45, 0, 0, '2015-01-10', 0, NULL, 'IN', 7, NULL),
(181, 2, NULL, 5, '2015-01-10', 'VENTA SEGÚN NOTA N° 000N1-0001', 0, 0, 0, 0, 0, 0, 0, 5.45, 0, 0, '2015-01-10', 0, NULL, 'IN', 7, NULL),
(182, 8, 6, NULL, '2015-01-15', 'COMPRA SEGÚN BOLETA N° 0002', 10, 80, 800, 0, 0, 0, 10, 80, 800, 2, '2015-01-15', 0, NULL, 'IN', 7, NULL),
(183, 2, 8, NULL, '2015-01-15', 'COMPRA SEGÚN BOLETA N° 12', 1, 5.45, 5.45, 0, 0, 0, 200, 5.45, 1090, 2, '2015-01-15', 0, NULL, 'IN', 7, NULL),
(184, 7, 9, NULL, '2015-01-15', 'COMPRA SEGÚN NOTA N° 2121', 1, 13, 13, 0, 0, 0, 1, 13, 13, 2, '2015-01-15', 0, NULL, 'IN', 7, NULL),
(185, 2, 10, NULL, '2015-01-15', 'COMPRA SEGÚN BOLETA N° 545', 1, 5.45, 5.45, 0, 0, 0, 1, 5.45, 5.45, 2, '2015-01-15', 0, NULL, 'IN', 7, NULL),
(186, 9, 12, NULL, '2015-01-15', 'COMPRA SEGÚN BOLETA N° 656', 1, 600, 600, 0, 0, 0, 1, 600, 600, 2, '2015-01-15', 0, NULL, 'IN', 7, NULL),
(187, 9, 13, NULL, '2015-01-15', 'COMPRA SEGÚN BOLETA N° 656', 1, 600, 600, 0, 0, 0, 2, 600, 1200, 2, '2015-01-15', 0, NULL, 'IN', 7, NULL),
(188, 9, 15, NULL, '2015-01-15', 'COMPRA SEGÚN FACTURA N° 156563', 100, 600, 60000, 0, 0, 0, 102, 600, 61200, 2, '2015-01-15', 0, NULL, 'IN', 7, NULL),
(189, 7, 16, NULL, '2015-01-15', 'COMPRA SEGÚN BOLETA N° 5454', 100, 13, 1300, 0, 0, 0, 101, 13, 1313, 2, '2015-01-15', 0, NULL, 'IN', 7, NULL),
(190, 8, 17, NULL, '2015-01-15', 'COMPRA SEGÚN BOLETA N° 00001-0001', 100, 80, 8000, 0, 0, 0, 110, 80, 8800, 2, '2015-01-15', 0, NULL, 'IN', 7, NULL),
(191, 8, 18, NULL, '2015-01-15', 'COMPRA SEGÚN FACTURA N° 00001-0001', 100, 80, 8000, 0, 0, 0, 210, 80, 16800, 2, '2015-01-15', 0, NULL, 'IN', 7, NULL),
(192, 8, 19, NULL, '2015-01-15', 'COMPRA SEGÚN BOLETA N° 0002', 100, 80, 8000, 0, 0, 0, 310, 80, 24800, 2, '2015-01-15', 0, NULL, 'IN', 7, NULL),
(193, 8, 20, NULL, '2015-01-15', 'COMPRA SEGÚN BOLETA N° 00001-0001', 100, 80, 8000, 0, 0, 0, 410, 80, 32800, 2, '2015-01-15', 0, NULL, 'IN', 7, NULL),
(194, 8, 21, NULL, '2015-01-15', 'COMPRA SEGÚN BOLETA N° 00001-0001', 100, 80, 8000, 0, 0, 0, 100, 80, 8000, 2, '2015-01-15', 2, '2015-01-18', 'IN', 7, NULL),
(195, 2, NULL, 6, '2015-01-20', 'VENTA SEGÚN FACTURA N° 001-0012', 0, 0, 0, 0, 0, 0, 0, 5.45, 0, 0, '2015-01-20', 0, NULL, 'IN', 7, NULL),
(196, 2, NULL, 6, '2015-01-20', 'VENTA SEGÚN FACTURA N° 001-0012', 0, 0, 0, 0, 0, 0, 0, 5.45, 0, 0, '2015-01-20', 0, NULL, 'IN', 7, NULL),
(197, 2, NULL, 6, '2015-01-20', 'VENTA SEGÚN FACTURA N° 001-0012', 0, 0, 0, 10, 5.45, 54.5, 191, 5.45, 1040.95, 2, '2015-01-20', 0, NULL, 'IN', 7, NULL),
(198, 7, NULL, 7, '2015-01-20', 'VENTA SEGÚN FACTURA N° 001-0013', 0, 0, 0, 10, 13, 130, 91, 13, 1183, 2, '2015-01-20', 0, NULL, 'AC', 7, NULL),
(199, 8, NULL, 8, '2015-01-20', 'VENTA SEGÚN FACTURA N° 001-0014', 0, 0, 0, 140, 80, 11200, 400, 80, 32000, 2, '2015-01-20', 0, NULL, 'IN', 7, NULL),
(200, 9, NULL, 9, '2015-01-20', 'VENTA SEGÚN FACTURA N° 001-0015', 0, 0, 0, 100, 600, 60000, 2, 600, 1200, 2, '2015-01-20', 0, NULL, 'AC', 7, NULL),
(201, 2, NULL, 10, '2015-01-20', 'VENTA SEGÚN FACTURA N° 001-0016', 0, 0, 0, 0, 0, 0, 0, 5.45, 0, 0, '2015-01-20', 0, NULL, 'AC', 7, NULL),
(202, 2, NULL, 10, '2015-01-20', 'VENTA SEGÚN FACTURA N° 001-0016', 0, 0, 0, 0, 0, 0, 0, 5.45, 0, 0, '2015-01-20', 0, NULL, 'AC', 7, NULL),
(203, 2, NULL, 10, '2015-01-20', 'VENTA SEGÚN FACTURA N° 001-0016', 0, 0, 0, 100, 5.45, 545, 91, 5.45, 495.95, 2, '2015-01-20', 0, NULL, 'AC', 7, NULL),
(204, 8, NULL, 11, '2015-01-20', 'VENTA SEGÚN FACTURA N° 001-0017', 0, 0, 0, 100, 80, 8000, 300, 80, 24000, 2, '2015-01-20', 0, NULL, 'IN', 7, NULL),
(205, 8, NULL, 12, '2015-01-20', 'VENTA SEGÚN FACTURA N° 001-0018', 0, 0, 0, 100, 80, 8000, 200, 80, 16000, 2, '2015-01-20', 0, NULL, 'AC', 7, NULL);
...
(1, 1, 1069, NULL, 'FACT. 6424', NULL, '2011-04-20', '2011-07-03', '2011-04-20', '650.20', 'SEICIENTOS CINCUENTA CON 20/100 NUEVOS SOLES', NULL, '2011-04-20', '2011-04-20', 2, 'DEUDA', NULL, NULL, NULL, NULL, NULL),
(2, 1, 1, '', NULL, NULL, '2015-01-20', '2015-01-25', NULL, '10000.00', NULL, NULL, '2015-01-20', NULL, 2, 'DEUDA', 'AC', NULL, NULL, NULL, 12),
(3, 1, 1, '', NULL, NULL, '2015-01-20', '2015-02-19', NULL, '1000.00', NULL, NULL, '2015-01-20', NULL, 2, 'DEUDA', 'AC', NULL, NULL, NULL, 12),
(4, 1, 2, '', NULL, NULL, '2015-01-20', '2015-04-20', NULL, '1000.00', NULL, NULL, '2015-01-20', NULL, 2, 'DEUDA', 'AC', NULL, NULL, NULL, 12),
(5, 1, 3, '', NULL, NULL, '2015-01-20', '2015-06-19', NULL, '1000.00', NULL, NULL, '2015-01-20', NULL, 2, 'DEUDA', 'AC', NULL, NULL, NULL, 12),
(6, 1, 4, '', NULL, NULL, '2015-01-20', '2015-08-18', NULL, '1000.00', NULL, NULL, '2015-01-20', NULL, 2, 'DEUDA', 'AC', NULL, NULL, NULL, 12),
(7, 1, 5, '', NULL, NULL, '2015-01-20', '2015-10-17', NULL, '1000.00', NULL, NULL, '2015-01-20', NULL, 2, 'DEUDA', 'AC', NULL, NULL, NULL, 12),
(8, 1, 6, '', NULL, NULL, '2015-01-20', '2015-12-16', NULL, '1000.00', NULL, NULL, '2015-01-20', NULL, 2, 'DEUDA', 'AC', NULL, NULL, NULL, 12),
(9, 1, 7, '', NULL, NULL, '2015-01-20', '2016-02-14', NULL, '1000.00', NULL, NULL, '2015-01-20', NULL, 2, 'DEUDA', 'AC', NULL, NULL, NULL, 12),
(10, 1, 8, '', NULL, NULL, '2015-01-20', '2016-04-14', NULL, '1000.00', NULL, NULL, '2015-01-20', NULL, 2, 'DEUDA', 'AC', NULL, NULL, NULL, 12),
(11, 1, 9, '', NULL, NULL, '2015-01-20', '2016-06-13', NULL, '1000.00', NULL, NULL, '2015-01-20', NULL, 2, 'DEUDA', 'AC', NULL, NULL, NULL, 12),
(12, 1, 10, '', NULL, NULL, '2015-01-20', '2016-08-12', NULL, '1000.00', NULL, NULL, '2015-01-20', NULL, 2, 'DEUDA', 'AC', NULL, NULL, NULL, 12);
...
(1, '1', 1, 0, '2015-01-15', '2015-01-30', NULL, 800, '2015-01-15', 2, NULL, NULL, 'DEUDA', 'AC', NULL, NULL, NULL, 21),
(2, '1', 2, 0, '2015-01-15', '2015-03-01', NULL, 800, '2015-01-15', 2, NULL, NULL, 'DEUDA', 'AC', NULL, NULL, NULL, 21),
(3, '1', 3, 0, '2015-01-15', '2015-03-31', NULL, 800, '2015-01-15', 2, NULL, NULL, 'DEUDA', 'AC', NULL, NULL, NULL, 21),
(4, '1', 4, 0, '2015-01-15', '2015-04-30', NULL, 800, '2015-01-15', 2, NULL, NULL, 'DEUDA', 'AC', NULL, NULL, NULL, 21),
(5, '1', 5, 0, '2015-01-15', '2015-05-30', NULL, 800, '2015-01-15', 2, NULL, NULL, 'DEUDA', 'AC', NULL, NULL, NULL, 21),
(6, '1', 6, 0, '2015-01-15', '2015-06-29', NULL, 800, '2015-01-15', 2, NULL, NULL, 'DEUDA', 'AC', NULL, NULL, NULL, 21),
(7, '1', 7, 0, '2015-01-15', '2015-07-29', NULL, 800, '2015-01-15', 2, NULL, NULL, 'DEUDA', 'AC', NULL, NULL, NULL, 21),
(8, '1', 8, 0, '2015-01-15', '2015-08-28', NULL, 800, '2015-01-15', 2, NULL, NULL, 'DEUDA', 'AC', NULL, NULL, NULL, 21),
(9, '1', 9, 0, '2015-01-15', '2015-09-27', NULL, 800, '2015-01-15', 2, NULL, NULL, 'DEUDA', 'AC', NULL, NULL, NULL, 21),
(10, '1', 10, 0, '2015-01-15', '2015-10-27', NULL, 800, '2015-01-15', 2, NULL, NULL, 'DEUDA', 'AC', NULL, NULL, NULL, 21),
(11, '1', 1, 0, '2015-01-18', '2015-02-02', NULL, 880, '2015-01-18', 2, NULL, NULL, 'DEUDA', 'AC', NULL, NULL, NULL, 21),
(12, '1', 2, 0, '2015-01-18', '2015-03-04', NULL, 880, '2015-01-18', 2, NULL, NULL, 'DEUDA', 'AC', NULL, NULL, NULL, 21),
(13, '1', 3, 0, '2015-01-18', '2015-04-03', NULL, 880, '2015-01-18', 2, NULL, NULL, 'DEUDA', 'AC', NULL, NULL, NULL, 21),
(14, '1', 4, 0, '2015-01-18', '2015-05-03', NULL, 880, '2015-01-18', 2, NULL, NULL, 'DEUDA', 'AC', NULL, NULL, NULL, 21),
(15, '1', 5, 0, '2015-01-18', '2015-06-02', NULL, 880, '2015-01-18', 2, NULL, NULL, 'DEUDA', 'AC', NULL, NULL, NULL, 21),
(16, '1', 6, 0, '2015-01-18', '2015-07-02', NULL, 880, '2015-01-18', 2, NULL, NULL, 'DEUDA', 'AC', NULL, NULL, NULL, 21),
(17, '1', 7, 0, '2015-01-18', '2015-08-01', NULL, 880, '2015-01-18', 2, NULL, NULL, 'DEUDA', 'AC', NULL, NULL, NULL, 21),
(18, '1', 8, 0, '2015-01-18', '2015-08-31', NULL, 880, '2015-01-18', 2, NULL, NULL, 'DEUDA', 'AC', NULL, NULL, NULL, 21),
(19, '1', 9, 0, '2015-01-18', '2015-09-30', NULL, 880, '2015-01-18', 2, NULL, NULL, 'DEUDA', 'AC', NULL, NULL, NULL, 21),
(20, '1', 10, 0, '2015-01-18', '2015-10-30', NULL, 880, '2015-01-18', 2, NULL, NULL, 'DEUDA', 'AC', NULL, NULL, NULL, 21);
...
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COLLATE=utf8_spanish_ci AUTO_INCREMENT=78 ;
...
(1, 220, 6956.52, 'D', 2, '2015-01-15', 2, '2015-01-18', 'AC', 'COMPRA/ Mercaderia / NRO de BOLETA: 00001-0001', NULL, '21', NULL, 'ASIENTO N1', '0', 7),
(2, 168, 1043.48, 'D', 2, '2015-01-15', 2, '2015-01-18', 'AC', 'TRIBUTOS POR PAGAR / Gobierno central / IGV / NRO de BOLETA: 00001-0001', NULL, '21', NULL, 'ASIENTO N1', '0', 7),
(3, 199, 8000, 'H', 2, '2015-01-15', 2, '2015-01-18', 'AC', 'PROVEEDORES / Facturas, boletas y otros comprobantes por pagar ', NULL, '21', NULL, 'ASIENTO N1', '0', 7),
(4, 57, 6956.52, 'D', 2, '2015-01-15', 2, '2015-01-18', 'AC', 'MERCADERIA / Almacen / NRO deBOLETA: 00001-0001', NULL, '21', NULL, 'ASIENTO N2', '0', 7),
(5, 225, 6956.52, 'H', 2, '2015-01-15', NULL, NULL, 'AC', 'VARIACION DE EXISTENCIAS / Mercaderia / NRO deBOLETA: 00001-0001', NULL, '21', NULL, 'ASIENTO N2', '0', 7),
(6, 199, 8000, 'D', 2, '2015-01-15', 2, '2015-01-18', 'AC', 'PROVEEDORES / Facturas, boletas y otros comprobantes por pagar ', NULL, '21', NULL, 'ASIENTO 3', '0', 7),
(7, 201, 800, 'H', 2, '2015-01-15', NULL, NULL, 'AC', 'PROVEEDORES/ letras por pagar / 2015-02-14 por el canje de la BOLETA NÂ°: 00001-0001', NULL, '21', NULL, 'ASIENTO N3', '0', 7),
(8, 201, 800, 'H', 2, '2015-01-15', NULL, NULL, 'AC', 'PROVEEDORES/ letras por pagar / 2015-03-16 por el canje de la BOLETA NÂ°: 00001-0001', NULL, '21', NULL, 'ASIENTO N3', '0', 13),
(9, 201, 800, 'H', 2, '2015-01-15', NULL, NULL, 'AC', 'PROVEEDORES/ letras por pagar / 2015-04-15 por el canje de la BOLETA NÂ°: 00001-0001', NULL, '21', NULL, 'ASIENTO N3', '0', 13),
(10, 201, 800, 'H', 2, '2015-01-15', NULL, NULL, 'AC', 'PROVEEDORES/ letras por pagar / 2015-05-15 por el canje de la BOLETA NÂ°: 00001-0001', NULL, '21', NULL, 'ASIENTO N3', '0', 11),
(11, 201, 800, 'H', 2, '2015-01-15', NULL, NULL, 'AC', 'PROVEEDORES/ letras por pagar / 2015-06-14 por el canje de la BOLETA NÂ°: 00001-0001', NULL, '21', NULL, 'ASIENTO N3', '0', 16),
(12, 201, 800, 'H', 2, '2015-01-15', NULL, NULL, 'AC', 'PROVEEDORES/ letras por pagar / 2015-07-14 por el canje de la BOLETA NÂ°: 00001-0001', NULL, '21', NULL, 'ASIENTO N3', '0', 12),
(13, 201, 800, 'H', 2, '2015-01-15', NULL, NULL, 'AC', 'PROVEEDORES/ letras por pagar / 2015-08-13 por el canje de la BOLETA NÂ°: 00001-0001', NULL, '21', NULL, 'ASIENTO N3', '0', 14),
(14, 201, 800, 'H', 2, '2015-01-15', NULL, NULL, 'AC', 'PROVEEDORES/ letras por pagar / 2015-09-12 por el canje de la BOLETA NÂ°: 00001-0001', NULL, '21', NULL, 'ASIENTO N3', '0', 15),
(15, 201, 800, 'H', 2, '2015-01-15', NULL, NULL, 'AC', 'PROVEEDORES/ letras por pagar / 2015-10-12 por el canje de la BOLETA NÂ°: 00001-0001', NULL, '21', NULL, 'ASIENTO N3', '0', 9),
(16, 201, 800, 'H', 2, '2015-01-15', NULL, NULL, 'AC', 'PROVEEDORES/ letras por pagar / 2015-11-11 por el canje de la BOLETA NÂ°: 00001-0001', NULL, '21', NULL, 'ASIENTO N3', '0', 8),
(17, 201, 880, 'H', 2, '2015-01-18', NULL, NULL, 'AC', 'PROVEEDORES/ letras por pagar / 2015-02-17 por el canje de la BOLETA NÂ°: 00001-0001', NULL, '21', NULL, 'ASIENTO N3', '0', 18),
(18, 201, 880, 'H', 2, '2015-01-18', NULL, NULL, 'AC', 'PROVEEDORES/ letras por pagar / 2015-03-19 por el canje de la BOLETA NÂ°: 00001-0001', NULL, '21', NULL, 'ASIENTO N3', '0', 13),
(19, 201, 880, 'H', 2, '2015-01-18', NULL, NULL, 'AC', 'PROVEEDORES/ letras por pagar / 2015-04-18 por el canje de la BOLETA NÂ°: 00001-0001', NULL, '21', NULL, 'ASIENTO N3', '0', 11),
(20, 201, 880, 'H', 2, '2015-01-18', NULL, NULL, 'AC', 'PROVEEDORES/ letras por pagar / 2015-05-18 por el canje de la BOLETA NÂ°: 00001-0001', NULL, '21', NULL, 'ASIENTO N3', '0', 16),
(21, 201, 880, 'H', 2, '2015-01-18', NULL, NULL, 'AC', 'PROVEEDORES/ letras por pagar / 2015-06-17 por el canje de la BOLETA NÂ°: 00001-0001', NULL, '21', NULL, 'ASIENTO N3', '0', 12),
(22, 201, 880, 'H', 2, '2015-01-18', NULL, NULL, 'AC', 'PROVEEDORES/ letras por pagar / 2015-07-17 por el canje de la BOLETA NÂ°: 00001-0001', NULL, '21', NULL, 'ASIENTO N3', '0', 14),
(23, 201, 880, 'H', 2, '2015-01-18', NULL, NULL, 'AC', 'PROVEEDORES/ letras por pagar / 2015-08-16 por el canje de la BOLETA NÂ°: 00001-0001', NULL, '21', NULL, 'ASIENTO N3', '0', 15),
(24, 201, 880, 'H', 2, '2015-01-18', NULL, NULL, 'AC', 'PROVEEDORES/ letras por pagar / 2015-09-15 por el canje de la BOLETA NÂ°: 00001-0001', NULL, '21', NULL, 'ASIENTO N3', '0', 15),
(25, 201, 880, 'H', 2, '2015-01-18', NULL, NULL, 'AC', 'PROVEEDORES/ letras por pagar / 2015-10-15 por el canje de la BOLETA NÂ°: 00001-0001', NULL, '21', NULL, 'ASIENTO N3', '0', 9),
(26, 201, 880, 'H', 2, '2015-01-18', NULL, NULL, 'AC', 'PROVEEDORES/ letras por pagar / 2015-11-14 por el canje de la BOLETA NÂ°: 00001-0001', NULL, '21', NULL, 'ASIENTO N3', '0', 8),
(27, 311, 50.85, 'H', 2, '2015-01-20', NULL, NULL, 'AC', 'VENTA/ Mercaderia / NRO de FACTURA: 001-0012', NULL, NULL, '6', 'ASIENTO N1', '0', 7),
(28, 168, 9.15, 'H', 2, '2015-01-20', NULL, NULL, 'AC', 'TRIBUTOS POR PAGAR / Gobierno central / IGV / NRO de FACTURA: 001-0012', NULL, NULL, '6', 'ASIENTO N1', '0', 7),
(29, 8, 60, 'D', 2, '2015-01-20', NULL, NULL, 'AC', 'Clientes / Facturas, boletas y otros comprobantes por pagar', NULL, NULL, '6', 'ASIENTO N1', '0', 7),
(30, 8, 60, 'H', 2, '2015-01-20', NULL, NULL, 'AC', 'Clientes / Facturas, boletas y otros comprobantes por pagar', NULL, NULL, '6', 'ASIENTO N1', '0', 7),
(31, 311, 132.2, 'H', 2, '2015-01-20', NULL, NULL, 'AC', 'VENTA/ Mercaderia / NRO de FACTURA: 001-0013', NULL, NULL, '7', 'ASIENTO N1', '0', 7),
(32, 168, 23.8, 'H', 2, '2015-01-20', NULL, NULL, 'AC', 'TRIBUTOS POR PAGAR / Gobierno central / IGV / NRO de FACTURA: 001-0013', NULL, NULL, '7', 'ASIENTO N1', '0', 7),
(33, 8, 156, 'D', 2, '2015-01-20', NULL, NULL, 'AC', 'Clientes / Facturas, boletas y otros comprobantes por pagar', NULL, NULL, '7', 'ASIENTO N1', '0', 7),
(34, 8, 156, 'H', 2, '2015-01-20', NULL, NULL, 'AC', 'Clientes / Facturas, boletas y otros comprobantes por pagar', NULL, NULL, '7', 'ASIENTO N1', '0', 7),
(35, 311, 11864.4, 'H', 2, '2015-01-20', NULL, NULL, 'AC', 'VENTA/ Mercaderia / NRO de FACTURA: 001-0014', NULL, NULL, '8', 'ASIENTO N1', '0', 7),
(36, 168, 2135.59, 'H', 2, '2015-01-20', NULL, NULL, 'AC', 'TRIBUTOS POR PAGAR / Gobierno central / IGV / NRO de FACTURA: 001-0014', NULL, NULL, '8', 'ASIENTO N1', '0', 7),
(37, 8, 14000, 'D', 2, '2015-01-20', NULL, NULL, 'AC', 'Clientes / Facturas, boletas y otros comprobantes por pagar', NULL, NULL, '8', 'ASIENTO N1', '0', 7),
(38, 8, 14000, 'H', 2, '2015-01-20', NULL, NULL, 'AC', 'Clientes / Facturas, boletas y otros comprobantes por pagar', NULL, NULL, '8', 'ASIENTO N1', '0', 7),
(39, 311, 63559.3, 'H', 2, '2015-01-20', NULL, NULL, 'AC', 'VENTA/ Mercaderia / NRO de FACTURA: 001-0015', NULL, NULL, '9', 'ASIENTO N1', '0', 7),
(40, 168, 11440.7, 'H', 2, '2015-01-20', NULL, NULL, 'AC', 'TRIBUTOS POR PAGAR / Gobierno central / IGV / NRO de FACTURA: 001-0015', NULL, NULL, '9', 'ASIENTO N1', '0', 7),
(41, 8, 75000, 'D', 2, '2015-01-20', NULL, NULL, 'AC', 'Clientes / Facturas, boletas y otros comprobantes por pagar', NULL, NULL, '9', 'ASIENTO N1', '0', 7),
(42, 8, 75000, 'H', 2, '2015-01-20', NULL, NULL, 'AC', 'Clientes / Facturas, boletas y otros comprobantes por pagar', NULL, NULL, '9', 'ASIENTO N1', '0', 7),
(43, 311, 508.47, 'H', 2, '2015-01-20', NULL, NULL, 'AC', 'VENTA/ Mercaderia / NRO de FACTURA: 001-0016', NULL, NULL, '10', 'ASIENTO N1', '0', 7),
(44, 168, 91.53, 'H', 2, '2015-01-20', NULL, NULL, 'AC', 'TRIBUTOS POR PAGAR / Gobierno central / IGV / NRO de FACTURA: 001-0016', NULL, NULL, '10', 'ASIENTO N1', '0', 7),
(45, 8, 600, 'D', 2, '2015-01-20', NULL, NULL, 'AC', 'Clientes / Facturas, boletas y otros comprobantes por pagar', NULL, NULL, '10', 'ASIENTO N1', '0', 7),
(46, 8, 600, 'H', 2, '2015-01-20', NULL, NULL, 'AC', 'Clientes / Facturas, boletas y otros comprobantes por pagar', NULL, NULL, '10', 'ASIENTO N1', '0', 7),
(47, 311, 8474.58, 'H', 2, '2015-01-20', NULL, NULL, 'AC', 'VENTA/ Mercaderia / NRO de FACTURA: 001-0017', NULL, NULL, '11', 'ASIENTO N1', '0', 7),
(48, 168, 1525.42, 'H', 2, '2015-01-20', NULL, NULL, 'AC', 'TRIBUTOS POR PAGAR / Gobierno central / IGV / NRO de FACTURA: 001-0017', NULL, NULL, '11', 'ASIENTO N1', '0', 7),
(49, 8, 10000, 'D', 2, '2015-01-20', NULL, NULL, 'AC', 'Clientes / Facturas, boletas y otros comprobantes por pagar', NULL, NULL, '11', 'ASIENTO N1', '0', 7),
(50, 8, 10000, 'H', 2, '2015-01-20', NULL, NULL, 'AC', 'Clientes / Facturas, boletas y otros comprobantes por pagar', NULL, NULL, '11', 'ASIENTO N1', '0', 7),
(51, 311, 8474.58, 'H', 2, '2015-01-20', NULL, NULL, 'AC', 'VENTA/ Mercaderia / NRO de FACTURA: 001-0018', NULL, NULL, '12', 'ASIENTO N1', '0', 7),
(52, 168, 1525.42, 'H', 2, '2015-01-20', NULL, NULL, 'AC', 'TRIBUTOS POR PAGAR / Gobierno central / IGV / NRO de FACTURA: 001-0018', NULL, NULL, '12', 'ASIENTO N1', '0', 7),
(53, 8, 10000, 'D', 2, '2015-01-20', NULL, NULL, 'AC', 'Clientes / Facturas, boletas y otros comprobantes por pagar', NULL, NULL, '12', 'ASIENTO N1', '0', 7),
(54, 8, 10000, 'H', 2, '2015-01-20', NULL, NULL, 'AC', 'Clientes / Facturas, boletas y otros comprobantes por pagar', NULL, NULL, '12', 'ASIENTO N1', '0', 7),
(55, 311, 8474.58, 'H', 2, '2015-01-20', NULL, NULL, 'AC', 'VENTA/ Mercaderia / NRO de FACTURA: 001-0018', NULL, NULL, '12', 'ASIENTO N1', '0', 7),
(56, 168, 1525.42, 'H', 2, '2015-01-20', NULL, NULL, 'AC', 'TRIBUTOS POR PAGAR / Gobierno central / IGV / NRO de FACTURA: 001-0018', NULL, NULL, '12', 'ASIENTO N1', '0', 7),
(57, 8, 10000, 'D', 2, '2015-01-20', NULL, NULL, 'AC', 'Clientes / Facturas, boletas y otros comprobantes por pagar', NULL, NULL, '12', 'ASIENTO N1', '0', 7),
(58, 8, 10000, 'H', 2, '2015-01-20', NULL, NULL, 'AC', 'Clientes / Facturas, boletas y otros comprobantes por pagar', NULL, NULL, '12', 'ASIENTO N1', '0', 7),
(59, 311, 8474.58, 'H', 2, '2015-01-20', NULL, NULL, 'AC', 'VENTA/ Mercaderia / NRO de FACTURA: 001-0018', NULL, NULL, '12', 'ASIENTO N1', '0', 7),
(60, 168, 1525.42, 'H', 2, '2015-01-20', NULL, NULL, 'AC', 'TRIBUTOS POR PAGAR / Gobierno central / IGV / NRO de FACTURA: 001-0018', NULL, NULL, '12', 'ASIENTO N1', '0', 7),
(61, 8, 10000, 'D', 2, '2015-01-20', NULL, NULL, 'AC', 'Clientes / Facturas, boletas y otros comprobantes por pagar', NULL, NULL, '12', 'ASIENTO N1', '0', 7),
(62, 8, 10000, 'H', 2, '2015-01-20', NULL, NULL, 'AC', 'Clientes / Facturas, boletas y otros comprobantes por pagar', NULL, NULL, '12', 'ASIENTO N1', '0', 7),
(63, 10, 10000, 'D', 2, '2015-01-20', NULL, NULL, 'AC', 'Clientes/ letras por pagar / 2015-02-04 por el canje de la FACTURA NÂ°: 001-0018', NULL, NULL, '12', 'ASIENTO N3', '0', 7),
(64, 311, 8474.58, 'H', 2, '2015-01-20', NULL, NULL, 'AC', 'VENTA/ Mercaderia / NRO de FACTURA: 001-0018', NULL, NULL, '12', 'ASIENTO N1', '0', 7),
(65, 168, 1525.42, 'H', 2, '2015-01-20', NULL, NULL, 'AC', 'TRIBUTOS POR PAGAR / Gobierno central / IGV / NRO de FACTURA: 001-0018', NULL, NULL, '12', 'ASIENTO N1', '0', 7),
(66, 8, 10000, 'D', 2, '2015-01-20', NULL, NULL, 'AC', 'Clientes / Facturas, boletas y otros comprobantes por pagar', NULL, NULL, '12', 'ASIENTO N1', '0', 7),
(67, 8, 10000, 'H', 2, '2015-01-20', NULL, NULL, 'AC', 'Clientes / Facturas, boletas y otros comprobantes por pagar', NULL, NULL, '12', 'ASIENTO N1', '0', 7),
(68, 10, 1000, 'D', 2, '2015-01-20', NULL, NULL, 'AC', 'Clientes/ letras por pagar / 2015-03-21 por el canje de la FACTURA NÂ°: 001-0018', NULL, NULL, '12', 'ASIENTO N3', '0', 18),
(69, 10, 1000, 'D', 2, '2015-01-20', NULL, NULL, 'AC', 'Clientes/ letras por pagar / 2015-05-20 por el canje de la FACTURA NÂ°: 001-0018', NULL, NULL, '12', 'ASIENTO N3', '0', 11),
(70, 10, 1000, 'D', 2, '2015-01-20', NULL, NULL, 'AC', 'Clientes/ letras por pagar / 2015-07-19 por el canje de la FACTURA NÂ°: 001-0018', NULL, NULL, '12', 'ASIENTO N3', '0', 12),
(71, 10, 1000, 'D', 2, '2015-01-20', NULL, NULL, 'AC', 'Clientes/ letras por pagar / 2015-09-17 por el canje de la FACTURA NÂ°: 001-0018', NULL, NULL, '12', 'ASIENTO N3', '0', 15),
(72, 10, 1000, 'D', 2, '2015-01-20', NULL, NULL, 'AC', 'Clientes/ letras por pagar / 2015-11-16 por el canje de la FACTURA NÂ°: 001-0018', NULL, NULL, '12', 'ASIENTO N3', '0', 8),
(73, 10, 1000, 'D', 2, '2015-01-20', NULL, NULL, 'AC', 'Clientes/ letras por pagar / 2016-01-15 por el canje de la FACTURA NÂ°: 001-0018', NULL, NULL, '12', 'ASIENTO N3', '0', 17),
(74, 10, 1000, 'D', 2, '2015-01-20', NULL, NULL, 'AC', 'Clientes/ letras por pagar / 2016-03-15 por el canje de la FACTURA NÂ°: 001-0018', NULL, NULL, '12', 'ASIENTO N3', '0', 17),
(75, 10, 1000, 'D', 2, '2015-01-20', NULL, NULL, 'AC', 'Clientes/ letras por pagar / 2016-05-14 por el canje de la FACTURA NÂ°: 001-0018', NULL, NULL, '12', 'ASIENTO N3', '0', 17),
(76, 10, 1000, 'D', 2, '2015-01-20', NULL, NULL, 'AC', 'Clientes/ letras por pagar / 2016-07-13 por el canje de la FACTURA NÂ°: 001-0018', NULL, NULL, '12', 'ASIENTO N3', '0', 17),
(77, 10, 1000, 'D', 2, '2015-01-20', NULL, NULL, 'AC', 'Clientes/ letras por pagar / 2016-09-11 por el canje de la FACTURA NÂ°: 001-0018', NULL, NULL, '12', 'ASIENTO N3', '0', 17);
...
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COLLATE=utf8_spanish_ci AUTO_INCREMENT=218 ;
...
INSERT INTO `personal` (`iPersonalId`, `cPersonalCodigo`, `vPersonalNombres`, `vPersonalApellidoPaterno`, `vPersonalApellidoMaterno`, `nPersonalNumeroDocumento`, `iUsuarioInsertaId`, `iUsuarioActualizaId`, `dFechaInserta`, `dFechaAcualiza`, `cEstadoCodigo`, `iSexoId`, `iTipoDocumentoId`, `iAreaId`) VALUES
(2, 'PER02', 'LIZ ', 'FERANADEZ', 'MELGAREJO', '12345678', 0, NULL, NULL, '2013-02-04', 'AC', 1, 1, 1),
(13, 'P003', 'DANIEL', 'CARPIO', 'NARVARTE', '25948454', 0, 0, NULL, '2014-03-13', 'AC', 2, 1, 3),
(14, 'SF001', 'SARITA', 'FERNANDEZ', 'MELGAREJO', '574456454', 0, 0, '2014-02-15', NULL, 'AC', 1, 1, 3),
(15, 'PE00015', 'DIEGO', 'GONZALES', 'VALDEZ', '46521231', 0, 0, '2015-01-01', NULL, 'AC', 2, 1, 3);
...
(377, '030311', '	SAN JUAN DE CHACÃ‘A	'),
(378, '030312', '	SAÃ‘AYCA	'),
(379, '030313', '	SORAYA	'),
...
(39, 2, 91, 5.45, 10, 6, 0, 0, 0, '2015-01-01 12:15:31', NULL, 'AC'),
(40, 2, 0, 5.45, 10, 6, 0, 0, 0, '2015-01-01 12:16:09', NULL, 'AC'),
(41, 2, 0, 5.45, 10, 6, 0, 0, 0, '2015-01-01 12:17:11', NULL, 'AC'),
(42, 8, 200, 80, 25, 100, 0, 0, 0, '2015-01-15 00:19:19', NULL, 'AC'),
...
(2, 'PR02', 'DURACEL GALON', '1', 2315, 20, 15, 6, 10, 5.45, 8, 2, NULL, '2013-05-23', 'AC', 3, 4, 0, 2, 1, 'CAJAS', NULL, 'PR02-duracel.jpg', NULL),
...
(8, 'PR00008', 'BOLSA TRES PLIEGOS', '42.5', 50170, 0, 0, 100, 25, 80, 2, 2, '2014-12-27', '2015-01-01', 'AC', 10, 1, 0, 1, 1, 'KILOGRAMO', 1, 'PR00008-cemento sol-42.jpg', 0),
...
INSERT INTO `usuario` (`iUsuarioId`, `cUsuarioCodigo`, `vUsuarioLogin`, `vUsuarioPassword`, `iUsuarioInsertaId`, `iUsuarioActualizaId`, `dFechaInserta`, `dFechaActualiza`, `cEstadoCodigo`, `iPerfilId`, `iPersonalId`) VALUES
(2, '', 'LFERNANDEZ', '123456', 1, NULL, '2011-04-24', NULL, 'AC', 2, 2),
(10, NULL, 'SARITAFERNANDEZ', 'sarita2014', 0, 0, NULL, '2014-03-13', 'AC', 3, 14),
(12, NULL, 'DANIELCARPIO', 'daniel2014', 0, 0, '2014-03-13', NULL, 'AC', 3, 13),
(13, NULL, '011', '2212', 0, 0, '2015-01-01', NULL, 'IN', 2, 2),
(14, NULL, '454', '66', 0, 0, '2015-01-01', NULL, 'IN', 2, 15),
(15, NULL, '645', 'gvfg', 0, 0, '2015-01-01', NULL, 'IN', 2, 13),
(16, NULL, '454', ' B', 0, 0, '2015-01-01', NULL, 'IN', 2, 15),
(17, NULL, 'BBB', 'BB', 0, 0, '2015-01-01', NULL, 'IN', 2, 2),
(18, NULL, 'MNJ', 'BB', 0, 0, '2015-01-01', NULL, 'IN', 2, 15),
(19, NULL, ' BB', 'BG', 0, 0, '2015-01-01', NULL, 'IN', 2, 15),
(20, NULL, 'DE', 'nn', 0, 0, '2015-01-01', NULL, 'IN', 2, 13),
(21, NULL, '656', '565', 0, 0, '2015-01-01', NULL, 'IN', 2, 15);
...
INSERT INTO `venta` (`iVentaId`, `nVentaNumero`, `dVentaFecha`, `fVentaTotal`, `iUsuarioInsertaId`, `dFechaInserta`, `iUsuarioActualizaId`, `dFechaActualiza`, `cEstadoCodigo`, `iUsuarioId`, `iClienteId`, `idireccionClienteId`, `iTipoDocumentoId`, `iFormaPago`, `cVentaOrdenCompra`, `nVentaRuc`, `vVentaPuntoLlegada`, `vPrincipal`, `fVentaGanancia`, `vEstadoVenta`, `fVentaSubTotal`, `fVentaIGV`, `vEstadoDocumento`, `dFechaTraslado`, `dFechaProximoPago`, `fDescuento`, `fMontoAdelantado`, `fVentaTotalReal`, `iNumeroDias`, `iNumeroLetras`, `IperiodoId`) VALUES
(1, '001-0001', '2011-03-11', 1100, 2, '2011-04-20', NULL, NULL, 'AC', 2, 1, 0, 1, 2, NULL, NULL, NULL, '0', '0.00', 'LETRA', 0, 0, 'DEUDA', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(2, '001-0005', '2011-05-12', 120, 2, '2011-04-20', NULL, NULL, 'AC', 2, 1, 0, 2, 2, NULL, NULL, NULL, '0', '0.00', 'LETRA', 0, 0, 'DEUDA', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(3, '001-0010', '2011-05-18', 18, 3, '2201-05-20', NULL, NULL, 'AC', 2, 1, 0, 1, 2, NULL, NULL, NULL, '0', '0.00', 'LETRA', 0, 0, 'DEUDA', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(4, '001-0011', '2015-01-08', 6, 0, '2015-01-08', 0, NULL, 'AC', 2, 1, 1, 1, 1, '', NULL, 'CARRETERA CENTRAL KM. 23.50CALLE 1 MZ L LT 6 ASOC. LA GRAMA', '1', '0.00', 'CANCELADO', 5.08, 0.92, 'CANCELADO', NULL, '2015-01-08', 0, 0, 6, 0, '1', '7'),
(5, '000N1-0001', '2015-01-10', 6, 0, '2015-01-10', 0, NULL, 'AC', 2, 1, 1, 3, 1, '', NULL, 'CARRETERA CENTRAL KM. 23.50CALLE 1 MZ L LT 6 ASOC. LA GRAMA', '1', '0.00', 'CANCELADO', 5.08, 0.92, 'CANCELADO', NULL, '2015-01-10', 0, 0, 6, 0, '1', '7'),
(6, '001-0012', '2015-01-20', 60, 0, '2015-01-20', 0, NULL, 'AC', 2, 1, 1, 1, 1, '', NULL, 'CARRETERA CENTRAL KM. 23.50CALLE 1 MZ L LT 6 ASOC. LA GRAMA', '1', '0.00', 'CANCELADO', 50.85, 9.15, 'CANCELADO', NULL, '2015-01-20', 0, 0, 60, 0, '1', '7'),
(7, '001-0013', '2015-01-20', 156, 0, '2015-01-20', 0, NULL, 'AC', 2, 1, 1, 1, 4, '', NULL, 'CARRETERA CENTRAL KM. 23.50CALLE 1 MZ L LT 6 ASOC. LA GRAMA', '1', '0.00', 'DEUDA', 132.2, 23.8, 'DEUDA', NULL, '2015-02-19', 0, 0, 156, 30, '1', '7'),
(8, '001-0014', '2015-01-20', 14000, 0, '2015-01-20', 0, NULL, 'AC', 2, 1, 1, 1, 1, '', NULL, 'CARRETERA CENTRAL KM. 23.50CALLE 1 MZ L LT 6 ASOC. LA GRAMA', '1', '0.00', 'CANCELADO', 11864.4, 2135.59, 'CANCELADO', NULL, '2015-01-20', 0, 0, 14000, 0, '1', '7'),
(9, '001-0015', '2015-01-20', 75000, 0, '2015-01-20', 0, NULL, 'AC', 2, 1, 1, 1, 6, '', NULL, 'CARRETERA CENTRAL KM. 23.50CALLE 1 MZ L LT 6 ASOC. LA GRAMA', '1', '0.00', 'DEUDA', 63559.3, 11440.7, 'DEUDA', NULL, '2015-02-19', 0, 0, 75000, 30, '10', '7'),
(10, '001-0016', '2015-01-20', 600, 0, '2015-01-20', 0, NULL, 'AC', 2, 1, 1, 1, 6, '', NULL, 'CARRETERA CENTRAL KM. 23.50CALLE 1 MZ L LT 6 ASOC. LA GRAMA', '1', '0.00', 'DEUDA', 508.47, 91.53, 'DEUDA', NULL, '2015-02-19', 0, 0, 600, 30, '6', '7'),
(11, '001-0017', '2015-01-20', 10000, 0, '2015-01-20', 0, NULL, 'AC', 2, 1, 1, 1, 6, '', NULL, 'CARRETERA CENTRAL KM. 23.50CALLE 1 MZ L LT 6 ASOC. LA GRAMA', '1', '0.00', 'DEUDA', 8474.58, 1525.42, 'DEUDA', NULL, '2015-02-19', 0, 0, 10000, 30, '10', '7'),
(12, '001-0018', '2015-01-20', 10000, 0, '2015-01-20', 0, NULL, 'AC', 2, 1, 1, 1, 6, '', NULL, 'CARRETERA CENTRAL KM. 23.50CALLE 1 MZ L LT 6 ASOC. LA GRAMA', '1', '0.00', 'DEUDA', 8474.58, 1525.42, 'DEUDA', NULL, '2015-02-19', 0, 0, 10000, 30, '10', '7');
...
(1, 30.9, 50, 1545, 0, '2013-02-22', 0, '2013-02-28', 'AC', 17, 1, NULL),
(2, 30.9, 100, 3090, 0, '2013-02-22', 0, '2013-02-28', 'AC', 17, 1, NULL),
(3, 6, 1, 6, 2, '2015-01-08', 0, NULL, 'AC', 2, 4, 0),
(4, 6, 1, 6, 2, '2015-01-10', 0, NULL, 'AC', 2, 5, 0),
(5, 6, 10, 60, 2, '2015-01-20', 0, NULL, 'AC', 2, 6, 0),
(6, 15.6, 10, 156, 2, '2015-01-20', 0, NULL, 'AC', 7, 7, 0),
(7, 100, 140, 14000, 2, '2015-01-20', 0, NULL, 'AC', 8, 8, 0),
(8, 750, 100, 75000, 2, '2015-01-20', 0, NULL, 'AC', 9, 9, 0),
(9, 6, 100, 600, 2, '2015-01-20', 0, NULL, 'AC', 2, 10, 0),
(10, 100, 100, 10000, 2, '2015-01-20', 0, NULL, 'AC', 8, 11, 0),
(11, 100, 100, 10000, 2, '2015-01-20', 0, NULL, 'AC', 8, 12, 0);
...
DECLARE  m INT;	 
   ...
   if(mes=2)then
	        ...
	        if ((anio % 4 = 0) && ((anio % 100 != 0) || (anio % 400 = 0)))then /*si el año es bisiesto es divisible entre 4 y 100 o 400*/
	             set  m=29;            
	       else
	          set  m=28 ;/*queda pendiente para año bisiesto*/	     
         end if ;
           ...
           /****************/
             ...
             * id= '199', '4', '421', 'Facturas, boletas y otros comprobantes por pagar'**/    
             ...
             IF xiFormaPagoId=1 THEN 
                 ...
                 cEstadoCodigo,vConceptoGeneral,
                 iIngresoProductoId, vNumeroAsiento,cCajaBanco, iPeriodoId) 
                 VALUES(2,total,'H',xiUsuarioId, NOW(), 'AC',CONCAT('CAJA Y BANCOS / Caja / ',NOW(),' Por el pago realizado de la compra de la mercaderia de la ',tipoDocumento,' NÂ°: ', numeroFactura)
               ...
               **/
               ...
               IF(xfMontoAdelantado !=0) THEN 
                 ...
                 * id=2, '1', '101', 'Caja'*/
                 ...
                 cEstadoCodigo,vConceptoGeneral,
                 iIngresoProductoId, vNumeroAsiento,cCajaBanco, iPeriodoId) 
                 VALUES(2,(total-xfMontoAdelantado),'H',xiUsuarioId, NOW(), 'AC',CONCAT('CAJA Y BANCOS / Caja / ',xfechaProximoPago,' Por el pago realizado de la compra al vencimiento de la',tipoDocumento,' NÂ°: ', numeroFactura),xId,'ASIENTO N3','1',xProximoiPeriodoId);
                 /**Cambiamos el estado del documento**/
                 /**Registro de estado Cuenta proveedor**/             
               ...
               ELSE 
                 ...
                 * id=2, '1', '101', 'Caja'*/
                 ...
                 cEstadoCodigo,vConceptoGeneral,
                 iIngresoProductoId, vNumeroAsiento,cCajaBanco, iPeriodoId) 
                 VALUES(2,total,'H',xiUsuarioId, NOW(), 'AC',CONCAT('CAJA Y BANCOS / Caja / ',xfechaProximoPago,' Por el pago del anticipo en la compra de mercaderÃ­a de la ',tipoDocumento,' NÂ°: ', numeroFactura),xId,'ASIENTO N3','1',xProximoiPeriodoId);
             ...
             WHILE x  <= xnumeroLetras DO 
              ...
              /**Agregamos al libro dirario la salida de caja 
                 ...
                 * id=201, '4', '423', 'Letras por pagar'*/
                 ...
                 cEstadoCodigo,vConceptoGeneral,
                 iIngresoProductoId, vNumeroAsiento,cCajaBanco, iPeriodoId) 
                 VALUES(201,importeLetra,'H',xiUsuarioId, NOW(), 'AC',CONCAT('PROVEEDORES/ letras por pagar / ',fechaVencimiento,' por el canje de la ',tipoDocumento,' NÂ°: ', numeroFactura),xId,'ASIENTO N3','0',xProximoiPeriodoId);
                SET  x = x + 1; 
                set fechaVencimiento=ADDDATE(fechaVencimiento,  xnumeroDias );
                END WHILE;
            END IF;            
         ...
         /**Pago al contado**/
             IF xiFormaPagoId=1 THEN 
              SELECT xiFormaPagoId;
                 ...
                 cEstadoCodigo,vConceptoGeneral,
                 iVentaId, vNumeroAsiento,cCajaBanco, iPeriodoId) 
                 VALUES(2,total,'D',xiUsuarioId, NOW(), 'AC',CONCAT('CAJA Y BANCOS / Caja / ',NOW(),' Por el pago realizado de la compra de la mercaderia de la ',tipoDocumento,' NÂ°: ', numeroFactura)
                 ,xId,'ASIENTO N3','1',xiPeriodoId);
               ...
               **/
               ...
               IF(xfMontoAdelantado !=0) THEN 
                 ...
                 * id=2, '1', '101', 'Caja'*/
                 ...
                 cEstadoCodigo,vConceptoGeneral,
                 iVentaId, vNumeroAsiento,cCajaBanco, iPeriodoId) 
                 VALUES(2,(total-xfMontoAdelantado),'D',xiUsuarioId, NOW(), 'AC',CONCAT('CAJA Y BANCOS / Caja / ',xfechaProximoPago,' Por el anticipio de la venta la',tipoDocumento,' NÂ°: ', numeroFactura),xId,'ASIENTO N3','1',xProximoiPeriodoId);
                 /**Cambiamos el estado del documento**/
                 /**Registro de estado Cuenta Cliente**/             
           ...
           /**Agregamos al Libro Diario las facturas de las pagar de las Ventas realizadas
             ...
             IF xiFormaPagoId=1 THEN 
              ...
              UPDATE  Librodiario SET cEstadoCodigo='EL' WHERE iVentaId=xId AND iPeriodoId=xiPeriodoId
                 ...
                 cEstadoCodigo,vConceptoGeneral,
                 iVentaId, vNumeroAsiento,cCajaBanco, iPeriodoId) 
                 VALUES(2,total,'D',xiUsuarioId, NOW(), 'AC',CONCAT('CAJA Y BANCOS / Caja / ',NOW(),' Por el pago realizado de la venta de la mercaderia de la ',tipoDocumento,' NÂ°: ', numeroFactura)
                 ,xId,'ASIENTO N3','1',xiPeriodoId);
               ...
               **/
               ...
               IF(xfMontoAdelantado !=0) THEN 
                 ...
                 * id=2, '1', '101', 'Caja'*/
                 ...
                 cEstadoCodigo,vConceptoGeneral,
                 iVentaId, vNumeroAsiento,cCajaBanco, iPeriodoId) 
                 VALUES(2,(total-xfMontoAdelantado),'D',xiUsuarioId, NOW(), 'AC',CONCAT('CAJA Y BANCOS / Caja / ',xfechaProximoPago,' Por el pago realizado de la venta  al vencimiento de la',tipoDocumento,' NÂ°: ', numeroFactura),xId,'ASIENTO N3','1',xProximoiPeriodoId);
                 /**Cambiamos el estado del documento**/
                 /**Registro de estado Cuenta Cliente**/             
               INSERT INTO EstadocuentaCliente(fMontoPago,dFechaPago,dFechaInserta, iUsuarioInsertaId,cEstadoCodigo,iClienteId,iVentaId)
               VALUES(xfMontoAdelantado,NOW(),NOW(),xiUsuarioId,'AC',xiClienteId,xId);
