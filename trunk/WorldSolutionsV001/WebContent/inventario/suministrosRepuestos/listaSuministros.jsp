     ...
     <tr>
      <% 
	   for (String per: listapermiso) {
			if(per!=null){
	   if(per.equals("1231")){%>
        <td><button  class="button" onclick="popup('productos.do?metodo=mantenimientoProducto&iclasificacionId=3&mode=I',700,635)">
...
<logic:notEmpty name="productosForm" property="produc"> 
	...
	<tr>
		...
		<img title="Editar" src="${pageContext.request.contextPath}/media/imagenes/edit.png"
		                     onclick="popup('productos.do?metodo=mantenimientoProducto&iclasificacionId=3&mode=U&id=<bean:write name="x" property="iProductoId" />',700,635)" />  
		 <% break; }}}%>
		</td>
		<td align="center">
		<%
