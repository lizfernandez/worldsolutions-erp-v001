...
<tr class="trCodigo">
    ...
    <td>
        <html:text property="cProductoCodigo" styleId="cProductoCodigo" styleClass="text" maxlength="7" onkeypress="return LetrasNumeros(event)" onkeyup="return mayuscula('cProductoCodigo') "/>
