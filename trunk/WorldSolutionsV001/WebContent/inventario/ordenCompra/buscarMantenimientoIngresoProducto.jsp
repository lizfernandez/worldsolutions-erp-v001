...
<tr>
    ...
    <td> <html:select  property="iTipoDocumentoId" styleId="iTipoDocumentoId" styleClass="combo" style="width:160px">    
...
<tr>
    ...
    <td>
         <html:select  property="iPeriodoId" styleId="iPeriodoId" styleClass="combo" style="width:160px">
              <option value="00">::SELECCIONE::</option>            
              <html:options collection="listaPeriodo" property="iPeriodoId" labelProperty="vCodigoPeriodo"/>
         </html:select>
        </td>
</tr>
<tr>
